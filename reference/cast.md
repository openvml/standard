...
The `<cast>` element groups all character definitions of the project in one document-level
container.
...
The `<cast>` element groups all characters and narrators of the project in a single document-level
container.
...
1. [`reference/character.md`](character.md)
2. [`reference/audio-processing.md`](audio-processing.md)
3. [`reference/video-processing.md`](video-processing.md)
4. [`reference/image-processing.md`](image-processing.md)

## 8. Design Principle

The `<cast>` element describes who the project's characters are, how their voices are requested, and
which processing presets are associated with them.
...
5. [`reference/audio-processing.md`](audio-processing.md)
6. [`reference/video-processing.md`](video-processing.md)
7. [`reference/image-processing.md`](image-processing.md)
