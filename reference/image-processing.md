...
Image processing uses the same declarative mechanism as video processing, applied to static rather
than temporal visual media.
...
2. [`reference/assets.md`](assets.md)
...
The semantic intents aspect_ratio, background_removal, and container_color are shared with video
processing:
...
Whether a particular implementation supports a given operation for still images is a runtime
capability.
...
Project-level processing applies as the default to the project's image material unless a more
...
1. [`reference/video-processing.md`](video-processing.md)
2. [`reference/media.md`](media.md)
3. [`reference/character.md`](character.md)
4. [`reference/cast.md`](cast.md)
5. [`reference/audio-processing.md`](audio-processing.md)
6. [`presets/README.md`](../presets/README.md)
