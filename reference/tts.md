...
OVML describes the speech content of a project. It does not require that speech be pre-rendered as a file.
...
This document describes how TTS is declared, how voices are resolved, and how OVML avoids storing credentials.
...
Failure to resolve a requested voice is a runtime/provider condition and is not, by itself, a structural OVML validation error.
...
This allows the same OVML document to be used by different Players, TTS engines, operating systems, and rendering environments.

## 18. Related Documents

See: concepts/packaging.md
See: reference/cast.md
